...
(cl:defmethod cl:initialize-instance :after ((m <Circle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Circle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_bringup-srv:<Circle-request> is deprecated: use dobot_bringup-srv:Circle-request instead.")))
...
(cl:defmethod x1-val ((m <Circle-request>))
...
(cl:defmethod y1-val ((m <Circle-request>))
...
(cl:defmethod z1-val ((m <Circle-request>))
...
(cl:defmethod a1-val ((m <Circle-request>))
...
(cl:defmethod b1-val ((m <Circle-request>))
...
(cl:defmethod c1-val ((m <Circle-request>))
...
(cl:defmethod x2-val ((m <Circle-request>))
...
(cl:defmethod y2-val ((m <Circle-request>))
...
(cl:defmethod z2-val ((m <Circle-request>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Circle-request>)))
  ...
  "595948d4551fca3138762c937ac2d5fd")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Circle-request)))
  "Returns md5sum for a message object of type 'Circle-request"
  "595948d4551fca3138762c937ac2d5fd")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Circle-request>)))
  ...
  (cl:format cl:nil "int32 count~%float64 x1~%float64 y1~%float64 z1~%float64 a1~%float64 b1~%float64 c1~%~%float64 x2~%float64 y2~%float64 z2~%float64 a2~%float64 b2~%float64 c2~%string[] paramValue~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Circle-request)))
  "Returns full string definition for message of type 'Circle-request"
  (cl:format cl:nil "int32 count~%float64 x1~%float64 y1~%float64 z1~%float64 a1~%float64 b1~%float64 c1~%~%float64 x2~%float64 y2~%float64 z2~%float64 a2~%float64 b2~%float64 c2~%string[] paramValue~%~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Circle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Circle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_bringup-srv:<Circle-response> is deprecated: use dobot_bringup-srv:Circle-response instead.")))
