...
(cl:defmethod cl:initialize-instance :after ((m <Arc-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arc-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_bringup-srv:<Arc-request> is deprecated: use dobot_bringup-srv:Arc-request instead.")))

(cl:ensure-generic-function 'x1-val :lambda-list '(m))
(cl:defmethod x1-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:x1-val is deprecated.  Use dobot_bringup-srv:x1 instead.")
  (x1 m))

(cl:ensure-generic-function 'y1-val :lambda-list '(m))
(cl:defmethod y1-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:y1-val is deprecated.  Use dobot_bringup-srv:y1 instead.")
  (y1 m))

(cl:ensure-generic-function 'z1-val :lambda-list '(m))
(cl:defmethod z1-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:z1-val is deprecated.  Use dobot_bringup-srv:z1 instead.")
  (z1 m))

(cl:ensure-generic-function 'a1-val :lambda-list '(m))
(cl:defmethod a1-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:a1-val is deprecated.  Use dobot_bringup-srv:a1 instead.")
  (a1 m))

(cl:ensure-generic-function 'b1-val :lambda-list '(m))
(cl:defmethod b1-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:b1-val is deprecated.  Use dobot_bringup-srv:b1 instead.")
  (b1 m))

(cl:ensure-generic-function 'c1-val :lambda-list '(m))
(cl:defmethod c1-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:c1-val is deprecated.  Use dobot_bringup-srv:c1 instead.")
  (c1 m))

(cl:ensure-generic-function 'x2-val :lambda-list '(m))
(cl:defmethod x2-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:x2-val is deprecated.  Use dobot_bringup-srv:x2 instead.")
  (x2 m))

(cl:ensure-generic-function 'y2-val :lambda-list '(m))
(cl:defmethod y2-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:y2-val is deprecated.  Use dobot_bringup-srv:y2 instead.")
  (y2 m))

(cl:ensure-generic-function 'z2-val :lambda-list '(m))
(cl:defmethod z2-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:z2-val is deprecated.  Use dobot_bringup-srv:z2 instead.")
  (z2 m))

(cl:ensure-generic-function 'a2-val :lambda-list '(m))
(cl:defmethod a2-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:a2-val is deprecated.  Use dobot_bringup-srv:a2 instead.")
  (a2 m))

(cl:ensure-generic-function 'b2-val :lambda-list '(m))
(cl:defmethod b2-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:b2-val is deprecated.  Use dobot_bringup-srv:b2 instead.")
  (b2 m))

(cl:ensure-generic-function 'c2-val :lambda-list '(m))
(cl:defmethod c2-val ((m <Arc-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dobot_bringup-srv:c2-val is deprecated.  Use dobot_bringup-srv:c2 instead.")
  (c2 m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Arc-request>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'a1))))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 48) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 56) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'b1))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Arc-request>) istream)
  "Deserializes a message object of type '<Arc-request>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'b1) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Arc-request>)))
  ...
  (cl:format cl:nil "float64 x1~%float64 y1~%float64 z1~%float64 a1~%float64 b1~%float64 c1~%~%float64 x2~%float64 y2~%float64 z2~%float64 a2~%float64 b2~%float64 c2~%string[] paramValue~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Arc-request)))
  "Returns full string definition for message of type 'Arc-request"
  (cl:format cl:nil "float64 x1~%float64 y1~%float64 z1~%float64 a1~%float64 b1~%float64 c1~%~%float64 x2~%float64 y2~%float64 z2~%float64 a2~%float64 b2~%float64 c2~%string[] paramValue~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <Arc-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arc-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dobot_bringup-srv:<Arc-response> is deprecated: use dobot_bringup-srv:Arc-response instead.")))
