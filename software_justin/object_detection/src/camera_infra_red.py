...
def process_realsense():
    model = YOLO("/home/mifood/catkin_ws_nova5/src/justin/software_justin/object_detection/src/yolov10n.pt")  # Update Model Path
    ...
    try:
        while True:
            ...
            frame = np.asanyarray(infrared_frame.get_data())
