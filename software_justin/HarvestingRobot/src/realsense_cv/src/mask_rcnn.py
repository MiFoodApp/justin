...
class MaskRCNN:
    def __init__(self):
        # Loading Mask RCNN
        dir1 = str(pathlib.Path(__file__).parent.resolve()) + "/dnn/frozen_inference_graph_coco.pb"
        dir2 = str(pathlib.Path(__file__).parent.resolve()) + "/dnn/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt"
        dir3 = str(pathlib.Path(__file__).parent.resolve()) + "/dnn/classes.txt"
        
        # print(dir + 'test\n\n')
        self.net = cv2.dnn.readNetFromTensorflow(dir1, dir2)
        ...
        self.classes = []
        with open(dir3, "r") as file_object:
