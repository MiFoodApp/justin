    ...
    while True:
        if apple_position != apple_position_check:  # Only ask for permission for each apple position once
            ...
            if is_picking_authorized == "Y":
                ...
                stem_rotation_joint_values = [6-TAU+stem_rotation, 0.82, -2.286, -4.8+TAU, 0.279-(pi/2), -TAU/4+(pi/2)]
                ...
                print(apple_position[0])
                print(apple_position[1])
                print(apple_position[2])
...
if __name__ == "__main__":
    ...
    sub_apple_position = rospy.Subscriber("object_position_camera_frame", Point, apple_position_callback)
