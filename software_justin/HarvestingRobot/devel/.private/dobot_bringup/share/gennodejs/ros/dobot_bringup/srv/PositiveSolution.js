...
class PositiveSolutionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PositiveSolutionRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PositiveSolutionRequest
    let len;
    let data = new PositiveSolutionRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PositiveSolutionRequest(null);
...
class PositiveSolutionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.res = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PositiveSolutionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PositiveSolutionResponse
    let len;
    let data = new PositiveSolutionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PositiveSolutionResponse(null);
...
module.exports = {
  Request: PositiveSolutionRequest,
  Response: PositiveSolutionResponse,
  md5sum() { return '8f42bcc802ab3546b7b7154a3d780925'; },
  datatype() { return 'dobot_bringup/PositiveSolution'; }
};
