...
class RelMovJRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RelMovJRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RelMovJRequest
    let len;
    let data = new RelMovJRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RelMovJRequest(null);
...
class RelMovJResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RelMovJResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RelMovJResponse
    let len;
    let data = new RelMovJResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RelMovJResponse(null);
...
module.exports = {
  Request: RelMovJRequest,
  Response: RelMovJResponse,
  md5sum() { return 'e279c0ec95d750d32f1bcdc49940f3d6'; },
  datatype() { return 'dobot_bringup/RelMovJ'; }
};
